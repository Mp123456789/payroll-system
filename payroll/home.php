...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <!-- <div class="w3-display-middle w3-large" > <h1 ><b>Welcome to Payroll system</b></h1></div> -->
      </div>
  ...
  <div class="w3-display-topmiddle" style="font-size: 45px">Welcome to payroll system</div>

  <!-- <div  style="font-size: 20px"><p>This is our homepage. We are developing this site.</p></div> -->
  
  <!-- <div class="w3-display-left w3-container"></div> -->
  <!-- <div class="w3-display-right w3-container"></div> -->
  <!-- <div class="w3-display-middle w3-large w3-text-black"><h1>Digital payroll system</h1></div> -->
